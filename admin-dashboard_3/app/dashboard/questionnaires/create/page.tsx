...
// import { DatePicker } from "@/components/ui/date-picker" // Removed to avoid redeclaration
...
export default function CreateQuestionnairePage() {
  ...
  const handleSave = () => {
    ...
    console.log("保存问卷:", { title, description, endDate, isAnonymous, questions })
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight">创建问卷</h1>
        </div>
